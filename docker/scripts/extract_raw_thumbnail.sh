...
/usr/local/bin/dcraw -T /tmp/imagefile
convert /tmp/imagefile.tiff -resize 640x360 -define modulate:colorspace=HSB -modulate 106,90,96\> /tmp/resized.jpg > /tmp/logfile 2>&1
CONVERT_EXIT=$?
cat /tmp/logfile
